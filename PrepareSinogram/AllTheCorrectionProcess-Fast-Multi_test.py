...
stride = 10
patches_all_org_siogram=numpy.zeros((10000000,args.patchsize,args.patchsize),dtype='f')


for i in range (0,originalsinogram[:,:,:].shape[0]):
    
    image_org=originalsinogram[i,:,:]
    
    # Extract patches using view_as_windows
    
    patches = view_as_windows(image_org, patch_size, step=stride)
...
print('The size of the patches from org sinogram=',patches_all_org_siogram.shape)
...
print('sinogram size to check is =',sinograminterpolated.shape[0],sinograminterpolated.shape[1],sinograminterpolated.shape[2])
...
ssim_ = ssim(originalsinogram[0,:,:], reconstructed_image_all[0,:,:], data_range=reconstructed_image_all[0,:,:].max() - reconstructed_image_all[0,:,:].min())

psnr_ = psnr(originalsinogram[0,:,:], reconstructed_image_all[0,:,:], data_range=reconstructed_image_all[0,:,:].max() - reconstructed_image_all[0,:,:].min())

print('SSIM and PSNR of corrected=',ssim_,psnr_)

ssim_ = ssim(originalsinogram[0,:,:], sinograminterpolated[0,:,:], data_range=sinograminterpolated[0,:,:].max() - sinograminterpolated[0,:,:].min())

psnr_ = psnr(originalsinogram[0,:,:], sinograminterpolated[0,:,:], data_range=sinograminterpolated[0,:,:].max() - sinograminterpolated[0,:,:].min())
...
ssim_ = ssim(originalsinogram[0,:,:], sinogramstreached[0,:,:], data_range=sinogramstreached[0,:,:].max() - sinogramstreached[0,:,:].min())

psnr_ = psnr(originalsinogram[0,:,:], sinogramstreached[0,:,:], data_range=sinogramstreached[0,:,:].max() - sinogramstreached[0,:,:].min())
...
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_Corrected_siogram_1",dpi=600,bbox_inches='tight')

plt.figure(10)
plt.axis('off')
#plt.title('Patches')
plt.imshow(pred_y_all[1200,:,:],cmap='gray')
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_Corrected_siogram_2",dpi=600,bbox_inches='tight')

plt.figure(11)
plt.axis('off')
#plt.title('Patches')
plt.imshow(pred_y_all[1500,:,:],cmap='gray')
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_Corrected_siogram_3",dpi=600,bbox_inches='tight')

plt.figure(12)
plt.axis('off')
#plt.title('Patches')
plt.imshow(pred_y_all[1800,:,:],cmap='gray')
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_Corrected_siogram_4",dpi=600,bbox_inches='tight')

plt.figure(13)
plt.axis('off')
#plt.title('Patches')
plt.imshow(patches_all_org_siogram[1000,:,:],cmap='gray')
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_org_siogram_1",dpi=600,bbox_inches='tight')

plt.figure(14)
plt.axis('off')
#plt.title('Patches')
plt.imshow(patches_all_org_siogram[1200,:,:],cmap='gray')
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_org_siogram_2",dpi=600,bbox_inches='tight')

plt.figure(15)
plt.axis('off')
#plt.title('Patches')
plt.imshow(patches_all_org_siogram[1500,:,:],cmap='gray')
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_org_siogram_3",dpi=600,bbox_inches='tight')

plt.figure(16)
plt.axis('off')
#plt.title('Patches')
plt.imshow(patches_all_org_siogram[1800,:,:],cmap='gray')
plt.savefig("/lhome/alsaffar/NewProjects/patches_all_org_siogram_4",dpi=600,bbox_inches='tight')
